...
int main(void)
{
	...
	Weight[0][0] = 0, Weight[0][1] = 7, Weight[0][2] = 4, Weight[0][3] = 6, Weight[0][4] = 1;				// 초기 그래프의 인접 행렬식 배열의 값을 정의
	Weight[1][0] = INF, Weight[1][1] = 0, Weight[1][2] = INF, Weight[1][3] = INF, Weight[1][4] = INF;
	Weight[2][0] = INF, Weight[2][1] = 2, Weight[2][2] = 0, Weight[2][3] = 5, Weight[2][4] = INF;
	Weight[3][0] = INF, Weight[3][1] = 3, Weight[3][2] = INF, Weight[3][3] = 0, Weight[3][4] = INF;
	Weight[4][0] = INF, Weight[4][1] = INF, Weight[4][2] = INF, Weight[4][3] = 1, Weight[4][4] = 0;
